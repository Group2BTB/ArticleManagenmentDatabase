...
INSERT INTO "tbl_article" VALUES ('13', 'sesf', '1', 'sfsfsf', '2015-07-01 13:49:04.409', null, '1', '1');
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "count_search_all"()
...
-- ----------------------------
-- Function structure for searchall
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchall"(IN _value varchar, IN _field varchar, IN _order_to varchar)
...
-- Function structure for searchall
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchall"(IN _value varchar, IN _field varchar, IN _order_to varchar, IN _s int4, IN _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
