...
-- ----------------------------
CREATE OR REPLACE FUNCTION "search_all"(_value varchar, _field varchar, _order_to varchar, _s int4, _e int4)
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "search_by_author"(IN _value varchar, IN _field varchar, IN _order_to varchar, IN _s int4, IN _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "search_by_id"(IN _value int4, IN _field varchar, IN _order_to varchar, IN _s int4, IN _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchbyauthor"(_value varchar, _field varchar, _order_to varchar)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- Function structure for searchbyauthor
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchbyauthor"(_value varchar, _field varchar, _order_to varchar, _s int4, _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchbyid"(_value varchar, _field varchar, _order_to varchar)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- Function structure for searchbyid
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchbyid"(_value varchar, _field varchar, _order_to varchar, _s int4, _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchbytitle"(_value varchar, _field varchar, _order_to varchar)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- Function structure for searchbytitle
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchbytitle"(IN _value varchar, IN _field varchar, IN _order_to varchar, IN _s int4, IN _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
-- Function structure for searchtitle
-- ----------------------------
CREATE OR REPLACE FUNCTION "searchtitle"(IN _value varchar, IN _field varchar, IN _order_to varchar, IN _s int4, IN _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
-- Function structure for select_all
-- ----------------------------
CREATE OR REPLACE FUNCTION "select_all"(IN _field varchar, IN _order_to varchar, IN _s int4, IN _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
				IF _field = 'id' AND _order_to = 'ASC' THEN 
						RETURN QUERY
...
-- ----------------------------
CREATE OR REPLACE FUNCTION "selectall"(_field varchar, _order_to varchar)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
			BEGIN
...
-- ----------------------------
-- Function structure for selectall(_field varchar, _order_to varchar, _s int4, _e int4)
-- ----------------------------
CREATE OR REPLACE FUNCTION "selectall(_field varchar, _order_to varchar, _s int4, _e int4)"(_field varchar, _order_to varchar, _s int4, _e int4)
  RETURNS SETOF "pg_catalog"."record" AS $BODY$
